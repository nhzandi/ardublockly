...
Blockly.Msg.PROCEDURES_DEFNORETURN_TITLE = "تابع";
Blockly.Msg.PROCEDURES_DEFNORETURN_TOOLTIP = "تابعی می‌سازد بدون هیچ خروجی.";
Blockly.Msg.PROCEDURES_DEFRETURN_HELPURL = "https://en.wikipedia.org/wiki/Procedure_%28computer_science%29";  // untranslated
Blockly.Msg.PROCEDURES_DEFRETURN_RETURN = "مقدار بازگشتی";
...
Blockly.Msg.TOOLBOX_FUNC = "توابع ";
Blockly.Msg.TOOLBOX_LOGIC = "منطقی ";
Blockly.Msg.TOOLBOX_LOOPS = "حلقه ";
Blockly.Msg.TOOLBOX_MATH = "ریاضی ";
Blockly.Msg.TOOLBOX_OUTPUT = "خروجی‌ها ";
Blockly.Msg.TOOLBOX_SENSOR = "سنسورها ";
Blockly.Msg.TOOLBOX_TIME = "تاخیر ";
Blockly.Msg.TOOLBOX_VAR = "متغیرها ";
...
Blockly.Msg.VARIABLES_SET = "تغییر %1 به %2";
...
Blockly.Msg.ARD_DRIVER_LED = "ال‌ای‌دی شماره %1 را %2 کن";
Blockly.Msg.ARD_FUN_RUN_LOOP = "درون یک حلقه اجرا کن:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "در ابتدای برنامه اجرا کن:";
...
Blockly.Msg.ARD_MICROSWITCH = "میکروسوییچ شماره";
Blockly.Msg.ARD_MOTOR_BACKWARD = "عقب";
Blockly.Msg.ARD_MOTOR_FORWARD = "جلو";
Blockly.Msg.ARD_MOTOR_ONBOARD = "چرخش موتور شماره %1 در جهت %2";
Blockly.Msg.ARD_MOTOR_PWM = "چرخش موتور شماره %1 در جهت %2 با سرعت %3";
Blockly.Msg.ARD_MOTOR_STOP = "موتور شماره %1 را متوقف کن";
...
Blockly.Msg.ARD_OFF = "خاموش";
Blockly.Msg.ARD_ON = "روشن";
...
Blockly.Msg.ARD_SENSOR_READ = "از کانکتور %1 مقدار سنسور %2 را بخوان";
...
Blockly.Msg.ARD_TIME_DELAY = "تاخیر";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "میکروثانیه";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "Wait specific time in microseconds";
Blockly.Msg.ARD_TIME_DELAY_MINS = "دقیقه";
Blockly.Msg.ARD_TIME_DELAY_SECS = "ثانیه";
...
Blockly.Msg.ARD_TIME_MS = "میلی ثانیه";
